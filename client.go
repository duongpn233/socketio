...
import (
	...
	"github.com/duongpn233/socketio/engineio/transport"
	"github.com/duongpn233/socketio/engineio/transport/websocket"
	"github.com/duongpn233/socketio/logger"
	"github.com/duongpn233/socketio/parser"
)
...
func (s *Client) Connect() error {
	if s.opts == nil {
		s.opts = &engineio.Options{
			Transports: []transport.Transport{websocket.Default},
		}
	}
	if s.opts.Transports == nil || len(s.opts.Transports) == 0 {
		s.opts.Transports = []transport.Transport{websocket.Default}
	}
